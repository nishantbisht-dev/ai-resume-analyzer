...
const AnalyzeResume = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (
      trimmedJobDescription.length < MIN_JOB_DESCRIPTION_LENGTH ||
      trimmedJobDescription.length > MAX_JOB_DESCRIPTION_LENGTH
    ) {
      toast.error(
        `Job description must be between ${MIN_JOB_DESCRIPTION_LENGTH} and ${MAX_JOB_DESCRIPTION_LENGTH} characters long`
      );
      return;
    }
  ...
  const currentCharacterCount = jobDescription.trim().length;
  const remainingCharacters = MIN_JOB_DESCRIPTION_LENGTH - currentCharacterCount;
  const isJobDescriptionValid =
    currentCharacterCount >= MIN_JOB_DESCRIPTION_LENGTH &&
    currentCharacterCount <= MAX_JOB_DESCRIPTION_LENGTH;
      ...
      <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-slate-600">
            Upload your resume PDF and paste a job description. AI will compare
            both and give you a match score, missing skills, and improvement
            suggestions.
          </p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Paste the job description here. It should include required skills, responsibilities, experience, tools, and job expectations..."
                rows={12}
              ...
              <div className="mt-2 flex flex-col gap-1 text-xs sm:flex-row sm:items-center sm:justify-between">
                ...
                >
                  Minimum {MIN_JOB_DESCRIPTION_LENGTH}, maximum{" "}
                ...
                >
                  {currentCharacterCount}/{MAX_JOB_DESCRIPTION_LENGTH} characters
                  {currentCharacterCount < MIN_JOB_DESCRIPTION_LENGTH
        ...
        <div className="rounded-[2rem] p-6 glass-card">
          ...
          {!analysis && !isAnalyzing && (
            <div className="flex min-h-96 flex-col items-center justify-center rounded-2xl bg-white/55 p-8 text-center">
          ...
          {isAnalyzing && (
            <div className="flex min-h-96 flex-col items-center justify-center rounded-2xl bg-violet-50/70 p-8 text-center">
              <Loader2 className="mb-4 animate-spin text-violet-600" size={48} />
  ...
  return (
    <ul className="space-y-3">
      {items.map((item, index) => (
        ...
        >
          <AlertCircle className="mt-0.5 shrink-0 text-violet-600" size={16} />
